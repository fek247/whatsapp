...
import { EllipsisVertical, Images, LockKeyhole, Pencil, PlusCircle } from "lucide-react";
                        ...
                        <DropdownMenuContent>
                            <DropdownMenuItem>
                                <div className="flex items-center">
                                    ...
                                    <p className="text-gray text-base">Ảnh và video</p>
                                </div>
                            </DropdownMenuItem>
                            <DropdownMenuItem>
                                <div className="flex items-center">
                                    <Pencil className="mr-3" />
                                    <p className="text-gray text-base">Văn bản</p>
                                </div>
                            </DropdownMenuItem>
                        </DropdownMenuContent>
                    </DropdownMenu>
                        ...
                        <DropdownMenuContent>
                            <DropdownMenuItem>
                                <div className="flex items-center">
                                    ...
                                    <p className="text-gray text-base">Status Privacy</p>
                                </div>
                            </DropdownMenuItem>
                        </DropdownMenuContent>
                    </DropdownMenu>
